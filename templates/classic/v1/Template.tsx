 ...
 * - Full-height hero section with background image support
                ...
                <div className="mx-auto max-w-2xl space-y-12">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Complete the form to let us know if you&apos;ll
                                join us
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
            ...
            <Sheet open={authDialogOpen} onOpenChange={setAuthDialogOpen}>
                <SheetContent>
                    <SheetHeader>
                        ...
                        <SheetDescription>
                            To confirm your attendance, we need to verify your
                            identity.
                        </SheetDescription>
                    </SheetHeader>
...
export default function ClassicTemplate({
    ...
    const sectionRegistry: Record<SectionKey, () => React.ReactNode> = {
        ...
        gifts: () => (
            <GiftsSection content={content.gifts} isPreview={isPreview} />
        ),
        rsvp: () => (
