...
export default function AdminDashboardPage() {
  ...
  const stats = weddings
    ? {
        ...
        draft: weddings.filter((w) => w.deployment.state === "draft").length,
        live: weddings.filter((w) => w.deployment.state === "live").length,
        preview: weddings.filter((w) => w.deployment.state === "preview").length,
      }
    : null;
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              {stats ? (
                <div className="text-2xl font-bold">{stats.preview}</div>
              ) : (
                <Skeleton className="h-8 w-16" />
              )}
            </CardContent>
